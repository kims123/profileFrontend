...
export function TicTacToeStart() {
    ...
    function restartGame() {
        ...
        setComputerButtons([])
        setGameOver(false)
        document.getElementById("tictactoe-status-text").innerText = "Who will be the winner d(◉◡◉)b"
    }

    const computerTurn = () => {
        console.log("Computer making his turn")
        while (true) {
    ...
    return (
        <div style={{display: "inline"}}>
            <div className="tictactoe-start-container">
                <button disabled={gameOver} className="tictactoe-start-grid-item" value="1"
                        onClick={() => pressButton1()}>{button1Value()}</button>
                <button disabled={gameOver} className="tictactoe-start-grid-item" value="2"
                        onClick={() => pressButton2()}>{button2Value()}</button>
                <button disabled={gameOver} className="tictactoe-start-grid-item" value="3"
                        onClick={() => pressButton3()}>{button3Value()}</button>
                <button disabled={gameOver} className="tictactoe-start-grid-item" value="4"
                        onClick={() => pressButton4()}>{button4Value()}</button>
                <button disabled={gameOver} className="tictactoe-start-grid-item" value="5"
                        onClick={() => pressButton5()}>{button5Value()}</button>
                <button disabled={gameOver} className="tictactoe-start-grid-item" value="6"
                        onClick={() => pressButton6()}>{button6Value()}</button>
                <button disabled={gameOver} className="tictactoe-start-grid-item" value="7"
                        onClick={() => pressButton7()}>{button7Value()}</button>
                <button disabled={gameOver} className="tictactoe-start-grid-item" value="8"
                        onClick={() => pressButton8()}>{button8Value()}</button>
                <button disabled={gameOver} className="tictactoe-start-grid-item" value="9"
